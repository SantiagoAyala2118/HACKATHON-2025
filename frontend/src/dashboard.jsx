...
const GradientButton = ({ text }) => (
    <button className="w-full px-2 py-2 my-2 text-gray-800 font-medium rounded-xl shadow-inner bg-white border-2 border-transparent transition-all duration-300
        bg-gradient-to-r from-emerald-900 via-orange-700 to-orange-900 p-[3px] hover:shadow-xl hover:scale-[1.02] active:scale-100">
                            ...
                            <button
                                ...
                                className={`
                                    ...
                                    ${activeTab === tab
                                        ...
                                        : 'text-emerald-900 hover:text-emerald-700 hover:bg-emerald-300 rounded-lg'
                                    }
                                `}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="col-span-1 space-y-4">
                                ...
                                {/* botones degradados de la izquierda */}
