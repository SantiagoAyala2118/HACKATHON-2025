        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-emerald-900 to-orange-900 p-4">
            ...
            >
                ...
                <h2 className="text-3xl font-bold mb-8 text-center text-gray-800">
                    {isLoginView ? (<>Iniciar <span className="border-b-2 border-orange-600 pb-[2px]">Sesión</span></>) : (<>Crear <span className="border-b-2 border-orange-600 pb-[2px]">Cuenta</span></>)}
                </h2>
                ...
                {!isLoginView && (
                    <>
                        <div className="mb-4">
                            <label htmlFor="selectOption" className="block text-sm font-semibold text-gray-700 mb-2">Seleccione su Rol</label>
                            {/* Borde degradado*/}
                ...
                <button 
                    ...
                    className={`w-full py-3 px-4 font-semibold rounded-lg shadow-xl transition duration-300 ${
                        loading? 'bg-gray-400 cursor-not-allowed text-gray-600' : 'bg-emerald-700 hover:bg-emerald-800 text-white'
                    }`}
                    disabled={loading}
                >
